...
const FOODS = [
  ...
  // ============ national / cultural dishes by country ============
  // ---- Middle East & North Africa ----
  { key: "cd_ksa_kabsa", emoji: "🇸🇦", name: { en: "Saudi Kabsa", ar: "كبسة سعودية" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 680, p: 36, c: 78, f: 24 },
  { key: "cd_egy_koshari", emoji: "🇪🇬", name: { en: "Egyptian Koshari", ar: "كشري مصري" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 550, p: 16, c: 95, f: 12 },
  { key: "cd_mar_tagine", emoji: "🇲🇦", name: { en: "Moroccan Tagine", ar: "طاجن مغربي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 480, p: 30, c: 40, f: 20 },
  { key: "cd_leb_kafta", emoji: "🇱🇧", name: { en: "Lebanese Kafta", ar: "كفتة لبنانية" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 420, p: 28, c: 8, f: 30 },
  { key: "cd_syr_kibbeh", emoji: "🇸🇾", name: { en: "Syrian Kibbeh", ar: "كبة سورية" }, serving: { en: "3 pieces", ar: "3 قطع" }, kcal: 380, p: 15, c: 28, f: 22 },
  { key: "cd_irq_masgouf", emoji: "🇮🇶", name: { en: "Iraqi Masgouf", ar: "مسكوف عراقي" }, serving: { en: "1 fillet", ar: "شريحة" }, kcal: 350, p: 40, c: 3, f: 18 },
  { key: "cd_tur_kebab", emoji: "🇹🇷", name: { en: "Turkish Adana Kebab", ar: "كباب أضنة تركي" }, serving: { en: "1 skewer", ar: "سيخ" }, kcal: 400, p: 26, c: 6, f: 30 },
  { key: "cd_irn_chelo", emoji: "🇮🇷", name: { en: "Persian Chelo Kabab", ar: "چلو كباب إيراني" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 700, p: 40, c: 80, f: 24 },
  { key: "cd_isr_falafel", emoji: "🧆", name: { en: "Falafel plate", ar: "صحن فلافل" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 500, p: 18, c: 55, f: 24 },
  { key: "cd_tun_couscous", emoji: "🇹🇳", name: { en: "Tunisian Couscous", ar: "كسكس تونسي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 520, p: 22, c: 70, f: 16 },
  { key: "cd_dza_shakshuka", emoji: "🇩🇿", name: { en: "Algerian Shakshuka", ar: "شكشوكة جزائرية" }, serving: { en: "1 pan", ar: "مقلاة" }, kcal: 330, p: 18, c: 16, f: 21 },
  { key: "cd_yem_saltah", emoji: "🇾🇪", name: { en: "Yemeni Saltah", ar: "سلتة يمنية" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 450, p: 22, c: 40, f: 22 },
  // ---- Europe ----
  { key: "cd_ita_lasagna", emoji: "🇮🇹", name: { en: "Italian Lasagna", ar: "لازانيا إيطالية" }, serving: { en: "1 piece", ar: "قطعة" }, kcal: 550, p: 28, c: 45, f: 28 },
  { key: "cd_esp_paella", emoji: "🇪🇸", name: { en: "Spanish Paella", ar: "بايلا إسبانية" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 600, p: 30, c: 75, f: 18 },
  { key: "cd_fra_ratatouille", emoji: "🇫🇷", name: { en: "French Ratatouille", ar: "راتاتوي فرنسي" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 220, p: 5, c: 25, f: 12 },
  { key: "cd_gbr_fishchips", emoji: "🇬🇧", name: { en: "Fish & Chips", ar: "سمك وبطاطا" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 840, p: 35, c: 80, f: 42 },
  { key: "cd_deu_schnitzel", emoji: "🇩🇪", name: { en: "German Schnitzel", ar: "شنيتزل ألماني" }, serving: { en: "1 piece", ar: "قطعة" }, kcal: 560, p: 35, c: 30, f: 32 },
  { key: "cd_grc_moussaka", emoji: "🇬🇷", name: { en: "Greek Moussaka", ar: "مسقعة يونانية" }, serving: { en: "1 piece", ar: "قطعة" }, kcal: 480, p: 22, c: 30, f: 30 },
  { key: "cd_prt_bacalhau", emoji: "🇵🇹", name: { en: "Portuguese Bacalhau", ar: "باكالياو برتغالي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 450, p: 40, c: 30, f: 18 },
  { key: "cd_pol_pierogi", emoji: "🇵🇱", name: { en: "Polish Pierogi", ar: "بيروغي بولندي" }, serving: { en: "6 pieces", ar: "6 قطع" }, kcal: 420, p: 12, c: 60, f: 14 },
  { key: "cd_rus_borscht", emoji: "🇷🇺", name: { en: "Russian Borscht", ar: "بورش روسي" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 180, p: 8, c: 22, f: 7 },
  { key: "cd_hun_goulash", emoji: "🇭🇺", name: { en: "Hungarian Goulash", ar: "جولاش مجري" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 380, p: 28, c: 22, f: 18 },
  { key: "cd_che_fondue", emoji: "🇨🇭", name: { en: "Swiss Cheese Fondue", ar: "فوندو سويسري" }, serving: { en: "1 serving", ar: "حصة" }, kcal: 520, p: 26, c: 12, f: 38 },
  { key: "cd_swe_meatballs", emoji: "🇸🇪", name: { en: "Swedish Meatballs", ar: "كرات لحم سويدية" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 560, p: 30, c: 40, f: 30 },
  { key: "cd_nld_stamppot", emoji: "🇳🇱", name: { en: "Dutch Stamppot", ar: "ستامبوت هولندي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 480, p: 18, c: 45, f: 24 },
  { key: "cd_ukr_varenyky", emoji: "🇺🇦", name: { en: "Ukrainian Varenyky", ar: "فارينيكي أوكراني" }, serving: { en: "6 pieces", ar: "6 قطع" }, kcal: 400, p: 11, c: 58, f: 13 },
  // ---- Asia ----
  { key: "cd_jpn_ramen", emoji: "🇯🇵", name: { en: "Japanese Ramen", ar: "رامن ياباني" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 500, p: 24, c: 65, f: 16 },
  { key: "cd_kor_bibimbap", emoji: "🇰🇷", name: { en: "Korean Bibimbap", ar: "بيبيمباب كوري" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 560, p: 22, c: 80, f: 16 },
  { key: "cd_chn_friedrice", emoji: "🇨🇳", name: { en: "Chinese Fried Rice", ar: "أرز مقلي صيني" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 520, p: 14, c: 78, f: 16 },
  { key: "cd_tha_padthai", emoji: "🇹🇭", name: { en: "Thai Pad Thai", ar: "باد تاي تايلندي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 560, p: 20, c: 70, f: 22 },
  { key: "cd_vnm_pho", emoji: "🇻🇳", name: { en: "Vietnamese Pho", ar: "فو فيتنامي" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 420, p: 25, c: 55, f: 8 },
  { key: "cd_ind_biryani", emoji: "🇮🇳", name: { en: "Indian Biryani", ar: "برياني هندي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 640, p: 24, c: 82, f: 24 },
  { key: "cd_ind_buttchicken", emoji: "🍛", name: { en: "Butter Chicken", ar: "دجاج بالزبدة" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 490, p: 30, c: 14, f: 34 },
  { key: "cd_pak_nihari", emoji: "🇵🇰", name: { en: "Pakistani Nihari", ar: "نهاري باكستاني" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 550, p: 35, c: 20, f: 36 },
  { key: "cd_idn_nasigoreng", emoji: "🇮🇩", name: { en: "Indonesian Nasi Goreng", ar: "ناسي غورينغ" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 540, p: 18, c: 72, f: 20 },
  { key: "cd_mys_nasilemak", emoji: "🇲🇾", name: { en: "Malaysian Nasi Lemak", ar: "ناسي لماك" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 600, p: 16, c: 78, f: 26 },
  { key: "cd_phl_adobo", emoji: "🇵🇭", name: { en: "Filipino Adobo", ar: "أدوبو فلبيني" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 520, p: 32, c: 30, f: 30 },
  { key: "cd_afg_kabuli", emoji: "🇦🇫", name: { en: "Afghan Kabuli Palaw", ar: "قابلي أفغاني" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 700, p: 30, c: 90, f: 26 },
  { key: "cd_lka_riceandcurry", emoji: "🇱🇰", name: { en: "Sri Lankan Rice & Curry", ar: "أرز وكاري سريلانكي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 560, p: 18, c: 85, f: 16 },
  { key: "cd_npl_dalbhat", emoji: "🇳🇵", name: { en: "Nepali Dal Bhat", ar: "دال بهات نيبالي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 550, p: 20, c: 90, f: 10 },
  // ---- Africa (sub-Saharan) ----
  { key: "cd_nga_jollof", emoji: "🇳🇬", name: { en: "Nigerian Jollof Rice", ar: "أرز جولوف نيجيري" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 560, p: 14, c: 82, f: 18 },
  { key: "cd_eth_injera", emoji: "🇪🇹", name: { en: "Ethiopian Injera & Wot", ar: "إنجيرا إثيوبية" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 480, p: 18, c: 70, f: 14 },
  { key: "cd_gha_fufu", emoji: "🇬🇭", name: { en: "Ghanaian Fufu & Soup", ar: "فوفو غاني" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 500, p: 20, c: 80, f: 10 },
  { key: "cd_zaf_bobotie", emoji: "🇿🇦", name: { en: "South African Bobotie", ar: "بوبوتي جنوب أفريقي" }, serving: { en: "1 piece", ar: "قطعة" }, kcal: 470, p: 26, c: 30, f: 26 },
  { key: "cd_ken_ugali", emoji: "🇰🇪", name: { en: "Kenyan Ugali & Sukuma", ar: "أوغالي كيني" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 380, p: 10, c: 70, f: 6 },
  { key: "cd_sen_thieboudienne", emoji: "🇸🇳", name: { en: "Senegalese Thieboudienne", ar: "تشيبوجين سنغالي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 600, p: 28, c: 80, f: 18 },
  // ---- Americas ----
  { key: "cd_usa_bbqribs", emoji: "🇺🇸", name: { en: "American BBQ Ribs", ar: "أضلاع باربكيو أمريكية" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 700, p: 45, c: 20, f: 48 },
  { key: "cd_mex_tacos", emoji: "🇲🇽", name: { en: "Mexican Tacos al Pastor", ar: "تاكو مكسيكي" }, serving: { en: "3 tacos", ar: "3 تاكو" }, kcal: 540, p: 28, c: 45, f: 26 },
  { key: "cd_bra_feijoada", emoji: "🇧🇷", name: { en: "Brazilian Feijoada", ar: "فيجوادة برازيلية" }, serving: { en: "1 bowl", ar: "صحن" }, kcal: 620, p: 35, c: 55, f: 28 },
  { key: "cd_arg_asado", emoji: "🇦🇷", name: { en: "Argentine Asado", ar: "أسادو أرجنتيني" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 700, p: 55, c: 2, f: 52 },
  { key: "cd_per_ceviche", emoji: "🇵🇪", name: { en: "Peruvian Ceviche", ar: "سيفيتشي بيروفي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 300, p: 35, c: 20, f: 8 },
  { key: "cd_col_bandeja", emoji: "🇨🇴", name: { en: "Colombian Bandeja Paisa", ar: "بانديخا كولومبية" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 1100, p: 50, c: 90, f: 55 },
  { key: "cd_ven_arepa", emoji: "🇻🇪", name: { en: "Venezuelan Arepa", ar: "أريبا فنزويلية" }, serving: { en: "1 arepa", ar: "واحدة" }, kcal: 380, p: 14, c: 45, f: 15 },
  { key: "cd_can_poutine", emoji: "🇨🇦", name: { en: "Canadian Poutine", ar: "بوتين كندي" }, serving: { en: "1 serving", ar: "حصة" }, kcal: 740, p: 20, c: 70, f: 44 },
  { key: "cd_jam_jerk", emoji: "🇯🇲", name: { en: "Jamaican Jerk Chicken", ar: "دجاج جيرك جامايكي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 480, p: 40, c: 20, f: 26 },
  { key: "cd_cub_ropavieja", emoji: "🇨🇺", name: { en: "Cuban Ropa Vieja", ar: "روبا فييخا كوبية" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 520, p: 34, c: 40, f: 22 },
  // ---- Oceania ----
  { key: "cd_aus_meatpie", emoji: "🇦🇺", name: { en: "Australian Meat Pie", ar: "فطيرة لحم أسترالية" }, serving: { en: "1 pie", ar: "فطيرة" }, kcal: 480, p: 18, c: 40, f: 27 },
  { key: "cd_nzl_hangi", emoji: "🇳🇿", name: { en: "New Zealand Hangi", ar: "هانغي نيوزيلندي" }, serving: { en: "1 plate", ar: "طبق" }, kcal: 560, p: 38, c: 45, f: 24 },
];
...
const FOOD_BASE = {
  ...
  // ---- national / cultural dishes ----
  cd_ksa_kabsa: [450, "g"], cd_egy_koshari: [400, "g"], cd_mar_tagine: [400, "g"], cd_leb_kafta: [350, "g"],
  cd_syr_kibbeh: [180, "g"], cd_irq_masgouf: [200, "g"], cd_tur_kebab: [150, "g"], cd_irn_chelo: [450, "g"],
  cd_isr_falafel: [350, "g"], cd_tun_couscous: [400, "g"], cd_dza_shakshuka: [300, "g"], cd_yem_saltah: [350, "g"],
  cd_ita_lasagna: [300, "g"], cd_esp_paella: [400, "g"], cd_fra_ratatouille: [250, "g"], cd_gbr_fishchips: [400, "g"],
  cd_deu_schnitzel: [250, "g"], cd_grc_moussaka: [300, "g"], cd_prt_bacalhau: [350, "g"], cd_pol_pierogi: [200, "g"],
  cd_rus_borscht: [350, "g"], cd_hun_goulash: [350, "g"], cd_che_fondue: [200, "g"], cd_swe_meatballs: [350, "g"],
  cd_nld_stamppot: [350, "g"], cd_ukr_varenyky: [200, "g"],
  cd_jpn_ramen: [500, "g"], cd_kor_bibimbap: [450, "g"], cd_chn_friedrice: [350, "g"], cd_tha_padthai: [350, "g"],
  cd_vnm_pho: [500, "g"], cd_ind_biryani: [400, "g"], cd_ind_buttchicken: [300, "g"], cd_pak_nihari: [350, "g"],
  cd_idn_nasigoreng: [350, "g"], cd_mys_nasilemak: [400, "g"], cd_phl_adobo: [350, "g"], cd_afg_kabuli: [450, "g"],
  cd_lka_riceandcurry: [400, "g"], cd_npl_dalbhat: [450, "g"],
  cd_nga_jollof: [350, "g"], cd_eth_injera: [400, "g"], cd_gha_fufu: [400, "g"], cd_zaf_bobotie: [300, "g"],
  cd_ken_ugali: [350, "g"], cd_sen_thieboudienne: [400, "g"],
  cd_usa_bbqribs: [400, "g"], cd_mex_tacos: [300, "g"], cd_bra_feijoada: [400, "g"], cd_arg_asado: [300, "g"],
  cd_per_ceviche: [250, "g"], cd_col_bandeja: [600, "g"], cd_ven_arepa: [200, "g"], cd_can_poutine: [350, "g"],
  cd_jam_jerk: [350, "g"], cd_cub_ropavieja: [350, "g"],
  cd_aus_meatpie: [180, "g"], cd_nzl_hangi: [400, "g"],
};
